...
HHANDLETABLE GCHandleStore::GetTable()
{
    ...
    // high 32-bits are for the handle info.
    int handleInfo = ctx->alloc_count >> 16;
...
//// fix 5 -
//HHANDLETABLE GCHandleStore::GetTable (HandleType type)
//{
//    if (!s_numTableSlots)
//    {
//        s_numTableSlots = getNumberOfSlots ();
//    }
//
//    uint64_t ts = GCToOSInterface::QueryPerformanceCounter ();
//    uint32_t ts_32bits = ts & 0xffffffff;
//    int cpuIndex = ts_32bits % s_numTableSlots;
//
//    dprintf (9999, ("ts is %I64d->%d, cpu index %d", ts, ts_32bits, cpuIndex));
//
//    HHANDLETABLE handletable = _underlyingBucket.pTable[cpuIndex];
//    return handletable;
//}
